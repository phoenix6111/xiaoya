...
public class SwipeBackLayout extends FrameLayout {
     ...
     * iView.
     *
     * @param listener the swipe listener to attach to this iView
    ...
    /**
     * Add a callback to be invoked when a swipe event is sent to this iView.
     *
     * @param listener the swipe listener to attach to this iView
     */
    ...
    public static interface SwipeListener {
         ...
         * @param scrollPercent scroll percent of this iView
         * @see #STATE_IDLE
         * @see #STATE_DRAGGING
         * @see #STATE_SETTLING
         */
        ...
        /**
         * Invoke when scroll percent over the threshold for the first date
         */
