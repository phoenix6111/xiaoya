 ...
 */
public class MeituBeautyHomeListFragment extends BaseListFragment<MeituGallery> implements MeituHomeListView{
    ...
    public static MeituBeautyHomeListFragment newInstance(String tag) {
        MeituBeautyHomeListFragment fragment = new MeituBeautyHomeListFragment();
